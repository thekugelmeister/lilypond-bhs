...
%%% @Section A.1.b
    ...
    %% \override InstrumentName.self-alignment-X = #LEFT
                                % TODO: This is silly. Document that.
                                % TODO: For some reason, I can't figure out how to not have to specify the markup formatting twice in the function below. It would be nice if it was less redundant.
                                         ...
                                         (lambda (grob default)
                                          (if (ly:stencil-empty? default)
                                           ...
                                           (let* ((layout (ly:grob-layout grob))
                                                  ...
                                                  (context-id (ly:grob-property grob 'id))
                                                  (m (cond
                                                      ((string-ci= context-id "TenorDividedStaff")
                                                       #{\markup \abs-fontsize #10 \left-column {"Tenor" "Lead"}#})
                                                      ((string-ci= context-id "BassDividedStaff")
                                                       #{\markup \abs-fontsize #10 \left-column {"Bari" "Bass"}#})
                                                    )))
...
%%% @Section A.12.a
    ...
    \override BarNumber.stencil = #(grob-transformer 'stencil
                                    (lambda (grob default)
                                     (if (string-ci= (ly:grob-property grob 'id) "TenorDividedStaff")
                                      default
                                      #f)))
...
TenorOneShortInstrumentName = ""

TenorTwoMusic = \BHSBarSandwich \LeadMusic
TenorTwoLyrics = \LeadLyrics
TenorTwoInstrumentName = "Lead"
TenorTwoShortInstrumentName = ""

BassOneMusic = \BHSBarSandwich \BariMusic
BassOneLyrics = \BariLyrics
BassOneInstrumentName = "Bari"
BassOneShortInstrumentName = ""

BassTwoMusic = \BHSBarSandwich \BassMusic
BassTwoLyrics = \BassLyrics
BassTwoInstrumentName = "Bass"
BassTwoShortInstrumentName = ""
